...
2. Drop [Fabric API](https://modrinth.com/mod/fabric-api/versions?g=26.1.2) into `mods`.
		3. Build this project (`./gradlew build`) and put `build/libs/voidmark-1.1.86.jar` in `mods`.
...
- The toolbar gear opens **Theme**: **Accent**, **Pane** color, and **Opacity** (the menu pane plus every HUD that uses that pane). Theme and feature panes stay more opaque than the main window so the text stays readable. Animation toggle is there too.
