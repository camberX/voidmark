...
- `/vm farmkeys` (or `/vm fk`) swaps the Attack/Destroy and Jump bindings. The swapped Attack/Destroy key toggles held attack on and off; run the command again to restore your original bindings.
